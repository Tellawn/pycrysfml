...
! use c-style indexing
DO i = 1, 3
 mgsymm%basf(i, vectorNum+1, symOpNum+1, irrRepNum+1) = &
CMPLX(v((2*i)-1), v(2*i))
END DO
...
obj_var%atm = new_value
 ...
 subroutine Atom_Equiv_List_Type_ctor(Atom_Equiv_List_Type_param, &
nauas_param, atm_param)
...
obj_var%Lab = new_value
 ...
 subroutine Atom_Equiv_Type_ctor(Atom_Equiv_Type_param, x_param, &
ChemSymb_param, mult_param, Lab_param)
...
obj_var%atom = new_value
 ...
 subroutine Atom_List_Type_ctor(Atom_List_Type_param, natoms_param, &
atom_param)
...
obj_var%MX = new_value
 ...
 subroutine Atom_Type_ctor(Atom_Type_param, LOcc_param, LVarF_param, &
Utype_param, MBiso_param, Occ_param, Charge_param, SfacSymb_param, &
Lab_param, MVarF_param, Moment_param, LU_param, MOcc_param, &
Active_param, Mult_param, X_Std_param, U_std_param, NVar_param, &
wyck_param, Biso_std_param, LBiso_param, Biso_param, VarF_param, &
U_param, Occ_Std_param, X_param, Z_param, MU_param, LX_param, &
ChemSymb_param, Ind_param, ThType_param, AtmInfo_param, Ueq_param, &
MX_param)
...
type (Atoms_Cell_Type) :: obj_var
 real(kind=cp), dimension( :,:), allocatable, intent(out) :: &
output_value
...
type (Atoms_Cell_Type) :: obj_var
 character (len=20), dimension(:), allocatable, intent(out) :: &
output_value
...
type (Atoms_Cell_Type) :: obj_var
 character (len=20), dimension(:), allocatable, intent(in) :: &
new_value
...
type (Atoms_Cell_Type) :: obj_var
 real(kind=cp), dimension(:, :,:), allocatable, intent(in) :: &
new_value
...
obj_var%neighb = new_value
 ...
 subroutine Atoms_Cell_Type_ctor(Atoms_Cell_Type_param, &
distance_param, ndist_param, ddist_param, xyz_param, charge_param, &
ddlab_param, noms_param, moment_param, neighb_atom_param, nat_param, &
var_free_param, trans_param, neighb_param)
...
obj_var%Atom = new_value
 ...
 subroutine mAtom_List_Type_ctor(mAtom_List_Type_param, natoms_param, &
Atom_param)
...
obj_var%MX = new_value
 ...
 subroutine mAtom_Type_ctor(mAtom_Type_param, mmphas_param, &
LOcc_param, SkI_std_param, LVarF_param, Utype_param, MBiso_param, &
Occ_param, lbas_param, Charge_param, SfacSymb_param, imat_param, &
lmphas_param, mphas_param, Spher_SkI_param, SkR_param, lskr_param, &
Lab_param, Moment_param, LU_param, MOcc_param, Active_param, &
SkI_param, Mult_param, Spher_SkR_std_param, X_Std_param, U_std_param, &
lski_param, NVar_param, wyck_param, Biso_std_param, LBiso_param, &
mphas_std_param, mVarF_param, Biso_param, VarF_param, U_param, &
Occ_Std_param, X_param, Z_param, nvk_param, mbas_param, &
Spher_SkI_std_param, Spher_SkR_param, mSki_param, SkR_std_param, &
MU_param, mSkR_param, LX_param, ChemSymb_param, cbas_param, Ind_param, &
cbas_std_param, ThType_param, AtmInfo_param, Ueq_param, MX_param)
...
obj_var%lcell = new_value
 ...
 subroutine Crystal_Cell_Type_ctor(Crystal_Cell_Type_param, &
lang_param, RCellVol_param, cell_std_param, ang_param, BL_Minv_param, &
GR_param, Cr_Orth_cel_param, BL_M_param, Orth_Cr_cel_param, &
CartType_param, rang_param, rcell_param, cell_param, GD_param, &
CellVol_param, ang_std_param, lcell_param)
...
obj_var%dtwofold = new_value
 ...
 subroutine Twofold_Axes_Type_ctor(Twofold_Axes_Type_param, a_param, &
c_param, b_param, maxes_param, ntwo_param, cross_param, tol_param, &
rtwofold_param, caxes_param, dot_param, dtwofold_param)
...
obj_var%uvw = new_value
 ...
 subroutine Zone_Axis_Type_ctor(Zone_Axis_Type_param, nlayer_param, &
rx_param, ry_param, uvw_param)
...
obj_var%nlines = new_value
 ...
 subroutine File_List_Type_ctor(File_List_Type_param, line_param, &
nlines_param)
...
type (Job_Info_type) :: obj_var
 type(interval_type),dimension(:), allocatable, intent(out) :: &
output_value
...
type (Job_Info_type) :: obj_var
 character(len=128), dimension(:), allocatable, intent(out) :: &
output_value
...
type (Job_Info_type) :: obj_var
 character(len=16), dimension(:), allocatable, intent(out) :: &
output_value
...
obj_var%Lambda = new_value
 ...
 subroutine Job_Info_type_ctor(Job_Info_type_param, dtt1_param, &
dtt2_param, range_2theta_param, Title_param, range_tof_param, &
Num_Phases_param, cmd_param, range_stl_param, range_d_param, &
Num_Patterns_param, Patt_typ_param, Phas_nam_param, Num_cmd_param, &
range_q_param, ratio_param, range_Energy_param, Lambda_param)
...
real(kind=cp)      ,dimension(:), allocatable, intent(in) :: dtt2_param
 type(interval_type),dimension(:), allocatable, intent(in) :: &
range_2theta_param
...
integer, intent(in) :: Num_Patterns_param
 character(len=16), dimension(:), allocatable, intent(in) :: &
Patt_typ_param
 character(len=128), dimension(:), allocatable, intent(in) :: &
Phas_nam_param
...
obj_var%mina = new_value
 ...
 subroutine interval_type_ctor(interval_type_param, maxb_param, &
mina_param)
...
obj_var%Rot = new_value
 ...
 subroutine MSym_Oper_Type_ctor(MSym_Oper_Type_param, Phas_param, &
Rot_param)
...
type (MagSymm_k_Type) :: obj_var
 character(len=40), dimension(:), allocatable, intent(out) :: &
output_value
...
type (MagSymm_k_Type) :: obj_var
 character(len=40), dimension(:,:), allocatable, intent(in) :: &
new_value
...
type (MagSymm_k_Type) :: obj_var
 type(MSym_Oper_Type),dimension(:,:), allocatable, intent(out) :: &
output_value
...
type (MagSymm_k_Type) :: obj_var
 type(MSym_Oper_Type),dimension(:,:), allocatable, intent(in) :: &
new_value
...
type (MagSymm_k_Type) :: obj_var
 type(Sym_Oper_Type), dimension(:), allocatable, intent(out) :: &
output_value
...
type (MagSymm_k_Type) :: obj_var
 type(Sym_Oper_Type), dimension(:), allocatable, intent(in) :: &
new_value
...
obj_var%Multip = new_value
 ...
 subroutine MagSymm_k_Type_ctor(MagSymm_k_Type_param, Latt_param, &
SymopSymb_param, MSymopSymb_param, Numops_param, BNS_symbol_param, &
BNS_number_param, mcentred_param, MagModel_param, kvec_param, &
nmsym_param, MSymOp_param, Num_Lat_param, irrep_action_param, &
small_irrep_dim_param, Ltr_param, Parent_num_param, Sk_type_param, &
nirreps_param, MagType_param, OG_number_param, irrep_dim_param, &
irrep_modes_number_param, nkv_param, irrep_direction_param, &
centred_param, basf_param, Parent_spg_param, OG_symbol_param, &
SymOp_param, irrep_id_param, nbas_param, icomp_param, Multip_param)
...
obj_var%trans = new_value
 ...
 subroutine Magnetic_Domain_type_ctor(Magnetic_Domain_type_param, &
Chir_param, pop_std_param, Mpop_param, nd_param, Lpop_param, &
pop_param, Twin_param, Lab_param, DMat_param, Dt_param, trans_param)
...
obj_var%SpG = new_value
 ...
 subroutine Magnetic_Group_Type_ctor(Magnetic_Group_Type_param, &
tinv_param, Shubnikov_param, SpG_param)
...
type (Magnetic_Space_Group_Type) :: obj_var
 Character(len=15), dimension(:),allocatable, intent(out) :: &
output_value
output_value = obj_var%irrep_id
...
obj_var%Num_aLat = new_value
 ...
 subroutine get_magnetic_space_group_small_irrep_dim(obj_var, &
output_value)
type (Magnetic_Space_Group_Type) :: obj_var
 Integer, dimension(:),allocatable, intent(out) :: output_value
output_value = obj_var%small_irrep_dim
...
obj_var%Num_gen = new_value
 ...
 subroutine get_magnetic_space_group_irrep_direction(obj_var, &
output_value)
type (Magnetic_Space_Group_Type) :: obj_var
 Character(len=20), dimension(:),allocatable, intent(out) :: &
output_value
...
obj_var%NumOps = new_value
 ...
 subroutine get_magnetic_space_group_irrep_modes_number(obj_var, &
output_value)
type (Magnetic_Space_Group_Type) :: obj_var
 Integer, dimension(:),allocatable, intent(out) :: output_value
output_value = obj_var%irrep_modes_number
 ...
 subroutine set_magnetic_space_group_irrep_modes_number(obj_var, &
new_value)
type (Magnetic_Space_Group_Type) :: obj_var
Integer,             dimension(:),allocatable, intent(in) :: new_value
obj_var%irrep_modes_number = new_value
...
obj_var%kv = new_value
 ...
 subroutine get_magnetic_space_group_trn_to_standard(obj_var, &
output_value)
type (Magnetic_Space_Group_Type) :: obj_var
Character(len=40), intent(out) :: output_value
...
obj_var%trn_to_standard = new_value
 ...
 subroutine get_magnetic_space_group_trn_from_parent(obj_var, &
output_value)
type (Magnetic_Space_Group_Type) :: obj_var
Character(len=40), intent(out) :: output_value
...
obj_var%Multip = new_value
 ...
 subroutine &
Magnetic_Space_Group_Type_ctor(Magnetic_Space_Group_Type_param, &
m_constr_param, Centre_coord_param, aLatt_trans_param, &
MSymopSymb_param, n_wyck_param, BNS_symbol_param, BNS_number_param, &
Latt_trans_param, Sh_number_param, Wyck_Symb_param, CrystalSys_param, &
m_cell_param, irrep_id_param, MSymOp_param, Num_Lat_param, &
Num_aLat_param, small_irrep_dim_param, Centred_param, SPG_lat_param, &
SymopSymb_param, Parent_num_param, kv_label_param, MagType_param, &
irrep_action_param, n_kv_param, OG_number_param, n_irreps_param, &
SPG_latsy_param, Num_gen_param, irrep_direction_param, &
standard_setting_param, SymOp_param, irrep_dim_param, &
Parent_spg_param, OG_symbol_param, Centre_param, mcif_param, &
NumOps_param, irrep_modes_number_param, kv_param, &
trn_to_standard_param, trn_from_parent_param, Multip_param)
...
logical, intent(in) :: m_cell_param
 Character(len=15), dimension(:),allocatable, intent(in) :: &
irrep_id_param
 type(MSym_Oper_Type),dimension(:),allocatable, intent(in) :: &
MSymOp_param
integer, intent(in) :: Num_Lat_param
...
Magnetic_Space_Group_Type_param%irrep_direction = irrep_direction_param
 Magnetic_Space_Group_Type_param%standard_setting = &
standard_setting_param
...
Magnetic_Space_Group_Type_param%NumOps = NumOps_param
 Magnetic_Space_Group_Type_param%irrep_modes_number = &
irrep_modes_number_param
...
obj_var%Mh = new_value
 ...
 subroutine MagHD_List_Type_ctor(MagHD_List_Type_param, Nref_param, &
Mh_param)
...
obj_var%MiV = new_value
 ...
 subroutine MagHD_Type_ctor(MagHD_Type_param, sqAMiV_param, &
num_k_param, H_param, sqMiV_param, s_param, MiVC_param, signp_param, &
MsF_param, AMiV_param, keqv_minus_param, MiV_param)
...
obj_var%Mh = new_value
 ...
 subroutine MagH_List_Type_ctor(MagH_List_Type_param, Nref_param, &
Mh_param)
...
obj_var%MiV = new_value
 ...
 subroutine MagH_Type_ctor(MagH_Type_param, num_k_param, H_param, &
sqMiV_param, s_param, MiVC_param, signp_param, keqv_minus_param, &
MsF_param, mult_param, MiV_param)
...
obj_var%Mult = new_value
 ...
 subroutine Reflect_Type_ctor(Reflect_Type_param, H_param, S_param, &
Mult_param)
...
obj_var%NRef = new_value
 ...
 subroutine Reflection_List_Type_ctor(Reflection_List_Type_param, &
Ref_param, NRef_param)
...
obj_var%Fo = new_value
 ...
 subroutine Reflection_Type_ctor(Reflection_Type_param, A_param, &
AA_param, B_param, BB_param, H_param, SFo_param, S_param, Fc_param, &
W_param, Phase_param, Mult_param, Fo_param)
...
obj_var%Multip = new_value
 ...
 subroutine NS_Space_Group_Type_ctor(NS_Space_Group_Type_param, &
Centred_param, SymopSymb_param, NumSpg_param, Latt_trans_param, &
CrystalSys_param, NumLat_param, PG_param, Hall_param, Info_param, &
SPG_lat_param, Laue_param, SPG_latsy_param, Num_gen_param, &
Bravais_param, SG_setting_param, gHall_param, SPG_Symb_param, &
Centre_coord_param, SymOp_param, Centre_param, NumOps_param, &
Multip_param)
...
obj_var%Rot = new_value
 ...
 subroutine NS_Sym_Oper_Type_ctor(NS_Sym_Oper_Type_param, Tr_param, &
Rot_param)
...
obj_var%Multip = new_value
 ...
 subroutine Space_Group_Type_ctor(Space_Group_Type_param, &
Centred_param, Centre_coord_param, Latt_trans_param, Hexa_param, &
NumSpg_param, SymopSymb_param, CrystalSys_param, NumLat_param, &
PG_param, Wyckoff_param, Hall_param, Info_param, SPG_lat_param, &
Laue_param, SPG_latsy_param, Num_gen_param, Bravais_param, &
SG_setting_param, gHall_param, SPG_Symb_param, Centre_param, &
SymOp_param, NumOps_param, R_Asym_Unit_param, Multip_param)
...
obj_var%str_orbit = new_value
 ...
 subroutine Wyck_Pos_Type_ctor(Wyck_Pos_Type_param, norb_param, &
str_orig_param, multp_param, site_param, str_orbit_param)
...
obj_var%orbit = new_value
 ...
 subroutine Wyckoff_Type_ctor(Wyckoff_Type_param, num_orbit_param, &
orbit_param)
...
obj_var%scans = new_value
 ...
 subroutine POWDER_Numor_Type_ctor(POWDER_Numor_Type_param, &
nbang_param, manip_param, icalc_param, monitor_param, nbdata_param, &
title_param, numor_param, Instrm_param, wave_param, header_param, &
Scantype_param, icdesc_param, angles_param, time_param, counts_param, &
nframes_param, conditions_param, tmc_ang_param, scans_param)
...
obj_var%sigma = new_value
 ...
 subroutine &
Diffraction_Pattern_Type_ctor(Diffraction_Pattern_Type_param, &
scal_param, conv_param, instr_param, yax_text_param, diff_kind_param, &
xmin_param, norm_mon_param, ymin_param, monitor_param, filepath_param, &
Title_param, nd_param, filename_param, ycalc_param, scat_var_param, &
step_param, x_param, ct_step_param, xax_text_param, istat_param, &
ymax_param, col_time_param, Tset_param, Tsamp_param, bgr_param, &
xmax_param, y_param, npts_param, sigma_param)
